...
func TestSlicePointerBinding(t *testing.T) {
	t.Run("without OmitSliceElementPointers", func(t *testing.T) {
		...
		require.Equal(t, ta.GO.String(), "[]*github.com/kyong0612/gqlgen/codegen/config/testdata/autobinding/chat.Message")
	})
...
func createBinder(cfg Config) (*Binder, *ast.Schema) {
	cfg.Models = TypeMap{
		"Message": TypeMapEntry{
			Model: []string{"github.com/kyong0612/gqlgen/codegen/config/testdata/autobinding/chat.Message"},
		},
	}
