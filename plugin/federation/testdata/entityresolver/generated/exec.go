...
import (
	...
	"github.com/kyong0612/gqlgen/plugin/federation/fedruntime"
...
func (ec *executionContext) _Entity_findManyMultiHelloByNames(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be []*github.com/kyong0612/gqlgen/plugin/federation/testdata/entityresolver/generated.MultiHello`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_findManyMultiHelloMultipleRequiresByNames(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be []*github.com/kyong0612/gqlgen/plugin/federation/testdata/entityresolver/generated.MultiHelloMultipleRequires`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_findManyMultiHelloRequiresByNames(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be []*github.com/kyong0612/gqlgen/plugin/federation/testdata/entityresolver/generated.MultiHelloRequires`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_findManyMultiHelloWithErrorByNames(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be []*github.com/kyong0612/gqlgen/plugin/federation/testdata/entityresolver/generated.MultiHelloWithError`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Entity_findManyMultiPlanetRequiresNestedByNames(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return nil, fmt.Errorf(`unexpected type %T from directive, should be []*github.com/kyong0612/gqlgen/plugin/federation/testdata/entityresolver/generated.MultiPlanetRequiresNested`, tmp)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
