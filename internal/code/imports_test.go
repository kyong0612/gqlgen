...
func TestExtractModuleName(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, "github.com/kyong0612/gqlgen", extractModuleName(content))
}
...
func TestImportPathForDir(t *testing.T) {
	...
	assert.Equal(t, "github.com/kyong0612/gqlgen/internal/code", ImportPathForDir(wd))

	assert.Equal(t, "github.com/kyong0612/gqlgen/internal/code", ImportPathForDir(wd))
	assert.Equal(t, "github.com/kyong0612/gqlgen/api", ImportPathForDir(filepath.Join(wd, "..", "..", "api")))

	// doesnt contain go code, but should still give a valid import path
	assert.Equal(t, "github.com/kyong0612/gqlgen/docs", ImportPathForDir(filepath.Join(wd, "..", "..", "docs")))

	// directory does not exist
	assert.Equal(t, "github.com/kyong0612/gqlgen/dos", ImportPathForDir(filepath.Join(wd, "..", "..", "dos")))
