...
For user defined types you can implement the [graphql.Marshaler](https://pkg.go.dev/github.com/kyong0612/gqlgen/graphql#Marshaler) and [graphql.Unmarshaler](https://pkg.go.dev/github.com/kyong0612/gqlgen/graphql#Unmarshaler) or implement the [graphql.ContextMarshaler](https://pkg.go.dev/github.com/kyong0612/gqlgen/graphql#ContextMarshaler) and [graphql.ContextUnmarshaler](https://pkg.go.dev/github.com/kyong0612/gqlgen/graphql#ContextUnmarshaler) interfaces and they will be called.
...
See the [\_examples/scalars](https://github.com/kyong0612/gqlgen/tree/master/_examples/scalars) package for more examples.
